...
class ComunasRegionesSeeder extends Seeder
{
    ...
    {
        $csvRegions = 'id,name,ordinal_symbol,order,created_at,updated_at
...
16,Magallanes y de la Antártica Chilena,XII,16,,';
        $regions = explode(PHP_EOL, $csvRegions);
        array_shift($regions);
        ...
        $csvCities = 'id,name,region_id,created_at,updated_at
        1,Arica,1,,
        2,Camarones,1,,
        3,General Lagos,1,,
        4,Putre,1,,
        ...
        346,Cabildo,6,,';
        $cities = explode(PHP_EOL, $csvCities);
        array_shift($cities);
