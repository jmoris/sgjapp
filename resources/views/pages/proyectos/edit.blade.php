...
@section('content')
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Gestión de Proyectos <small style="font-size:.75em;color: grey;">#{{ str_pad($proyecto->id, 5, '0', STR_PAD_LEFT); }}</small></h4>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                <h4 class="card-title mb-0">FORMULARIO DE EDICIÓN DE PROYECTO</h4>
                            </div>
                            <div class="row mx-2">
