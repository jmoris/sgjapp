...
@section('content')
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Gestión de Proveedores <small style="font-size:.75em;color: grey;">#{{ str_pad($proveedor->id, 5, '0', STR_PAD_LEFT); }}</small></h4>
        </div>
    </div>
    <div class="row">
                                                ...
                                                <div class="mx-2">
                                                    <div class="mb-2">
                                                        ...
                                                        <input type="text" name="rut" id="rut" class="form-control"
                                                            placeholder="Ingrese el R.U.T del proveedor" value="{{ $proveedor->rut }}" readonly>
                                                    </div>
                                                    <div class="mb-2">
                                                        <label class="form-label">Razón social</label>
                                                        <input type="text" name="razon_social" id="razon_social" class="form-control"
                                                            placeholder="Ingrese la razón social del proveedor" value="{{ $proveedor->razon_social }}">
                                                    </div>
                                                    <div class="mb-2">
                                                        <label class="form-label">Actividad Económica</label>
                                                        <input type="text" name="giro" id="giro" class="form-control"
                                                            placeholder="Ingrese el giro del proveedor" value="{{ $proveedor->giro }}">
                                                    </div>
                                                    <div class="mb-2">
                                                        <label class="form-label">Dirección</label>
                                                        <input type="text" name="direccion" id="direccion" class="form-control"
                                                            placeholder="Ingrese la dirección comercial del proveedor" value="{{ $proveedor->direccion }}">
                                                    </div>
                                                    <div class="mb-4">
                                                        ...
                                                        <select id="comuna" name="comuna" class="js-example-basic-single form-select" data-width="100%">
                                                            ...
                                                            <option value="{{ $comuna->id }}" @if($comuna->id == $proveedor->comuna_id) selected @endif>{{ $comuna->nombre }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mx-2">
                                                    <div class="mb-2">
                                                        ...
                                                        <input type="text" name="telefono" id="telefono" class="form-control"
                                                            placeholder="Ingrese el telefono de contacto del proveedor" value="{{ $proveedor->telefono }}">
                                                    </div>
                                                    <div class="mb-2">
                                                        <label class="form-label">Correo de contacto</label>
                                                        <input type="text" name="correo_contacto" id="correo_contacto" class="form-control"
                                                            placeholder="Ingrese el correo de contacto del proveedor" value="{{ $proveedor->email }}">
                                                    </div>
                                                    <div class="mb-2">
                                                        <label class="form-label">Página web</label>
                                                        <input type="text" name="web" id="web" class="form-control"
                                                            placeholder="Ingrese la página web del proveedor" value="{{ $proveedor->web }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $("#storeForm").validate({
            ...
            submitHandler: function(form) {
                $.ajax({
                    type: "POST",
                    url: '/api/proveedores/editar/{{ $proveedor->id }}',
