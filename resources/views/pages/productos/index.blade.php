                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                <h6 class="card-title mb-3">LISTA DE PRODUCTOS</h6>
                            </div>
                            <div class="row">
                                <div class="col-12">
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            Swal.fire({
                                ...
                                text: "El producto seleccionado fue eliminado satisfactoriamente",
                                icon: "success"
                            });
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        console.log(row);
                        var html = '<div><button type="button" title="Editar Usuario" onclick="editUser('+row.id+')" class="btn btnxs px-1 py-0"><i class="mdi mdi-pencil"></i></button>' +
                            '<button type="button" onclick="deleteUser('+row.id+')" title="Eliminar Usuario" class="btn btnxs px-1 py-0"><i class="mdi mdi-trash-can"></i></button></div>';
                        return html;
                    }
                },
            ],
