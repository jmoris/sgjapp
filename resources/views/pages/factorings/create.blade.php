                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                <h4 class="card-title mb-0">FORMULARIO DE NUEVO FACTORING</h4>
                            </div>
                            <div class="row mx-2">
                                ...
                                <div class="col-md-12">
                                    <form class="form" id="storeForm">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="mx-2">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" name="correo_cesion" id="correo_cesion"
                                                            class="form-control"
                                                ...
                                                <div class="mx-2">
                                                    <div class="mb-2">
                                                        ...
                                                        <input type="text" name="nombre_ejecutivo" id="nombre_ejecutivo"
                                                            class="form-control"
                                                            placeholder="Ingrese el nombre del ejecutivo de factoring">
                                                    </div>
                                                    <div class="mb-2">
                                                        <label class="form-label">Correo de contacto</label>
                                                        <input type="text" name="correo_ejecutivo" id="correo_ejecutivo"
                                                            class="form-control"
                                                            placeholder="Ingrese el correo de contacto del ejecutivo de factoring">
                                                    </div>
                                                </div>
                                                <div class="mb-2 border-bottom">
                                        ...
                                        <button type="button" class="btn btn-danger"
                                            onclick="location.href = '/factorings'">
    ...
    <script>
        ...
        var validator = $("#storeForm").validate({
            ...
            messages: {
                ...
                correo_cesion: "El correo de intercambio es obligatorio"
            },
            ...
            submitHandler: function(form) {
                var data = {
                    ...
                    comuna: $('#comuna').val(),
                    correo_cesion: $('#correo_cesion').val(),
                    nombre_ejecutivo: $('#correo_ejecutivo').val(),
                    correo_ejecutivo: $('#correo_ejecutivo').val(),
